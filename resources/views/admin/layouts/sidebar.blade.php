<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ Request::is('admin/kamar*') ? 'active':'' }}">
            <a href="{{ route('admin.kamar.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-bed"></i> 
                <div class="text-truncate" data-i18n="Kamar">Kamar</div>
            </a>
        </li>
        
        
        <li class="menu-item {{ Request::is('admin/penghuni*') ? 'active':'' }}">
            <a href="{{ route('admin.penghuni.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-user"></i> 
                <div class="text-truncate" data-i18n="Penghuni Kost">Penghuni Kost</div>
            </a>
        </li>
