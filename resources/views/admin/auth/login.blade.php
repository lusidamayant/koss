    ...
    <div class="card-body">
        ...
        <div class="app-brand justify-content-center">
            <a href="index-2.html" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo text-heading fw-bold">Admin Kos Rempah</span>
            </a>
        </div>
        <!-- /Logo -->

        <form id="formAuthentication" class="mb-6" action="{{ route('admin.authLogin') }}" method="POST">
            @csrf
            <div class="mb-6">
